    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('add-sub-category')}}" class="btn btn-primary">New Sub Category</a>
            </div>
            @endcan
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <a href="{{route('edit-sub-category', ['id' => $category->id])}}">
                                ...
                                <form method="POST"
                                    action="{{ route('delete-sub-category', ['id' => $category->id]) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
